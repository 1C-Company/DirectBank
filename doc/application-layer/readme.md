...
## <a name="6"></a> Таблица кодов статусов электронных документов
...
## <a name="7"></a> Таблица типов выписок банка
...
## <a name="8"></a> Таблица кодов ошибок и их описание, которые может возвращать банковский сервис в «1С:Предприятие 8»
