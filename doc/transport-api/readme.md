...
Если после получения и разбора всех пакетов документов из списка 1С не находит нужный пакет, процесс будет начат заново. Это происходит при ожидания  получения выписки банка.
