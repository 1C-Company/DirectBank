...
Аутентификация Клиента с целью создания сессии на сервисе Банка может проходить по логину и паролю + дополнительный OTP («one time password», опционально) ([Logon](#logon)) или по закрытому ключу сертификата. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyNDQ4NjQzMSwtMTU5MDc2NDAzMywtNj
k2MzkzNDM4XX0=
-->