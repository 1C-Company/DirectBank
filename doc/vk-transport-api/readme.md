...
**Примечание 1**: *В настройках ЭД необходимо указать, что ЭД Запрос-зонд должен подписываться нужно для тестирования функций подписи/проверки подписи при настройке пользователем DirectBank.*
